...
public class K_DistinctGroups {

    public static boolean distinctGroup(int[] arr, int k){
       if(arr.length%k!=0){
           return false;
       }
    ...
    public static void main(String[] args) {
        ...
        System.out.println("tell me the number of distinct groups that you want:-");
        int k=sc.nextInt();

        boolean ans=distinctGroup(arr1,k);

        System.out.println("is it possible? "+ans);
